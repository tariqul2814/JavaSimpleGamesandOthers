...
public class Gamee extends JFrame implements ActionListener,ItemListener
{
	...
	public Gamee()
	{
		...
		label1 = new JLabel("Choose User Mark: ");
	...
	public void itemStateChanged(ItemEvent evt) {
		...
		if(evt.getSource()==box1)
		{
			...
			String J = "User Player: "+value+"  &&  Computer: "+value1;
			label2.setText(J);
		}
  }
